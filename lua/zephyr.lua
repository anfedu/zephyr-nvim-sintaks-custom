...
function zephyr.load_syntax()
  local syntax = {
    ...
    Search = {fg = 'springgreen', bg = zephyr.none},
    ...
    CursorLine = {fg = zephyr.none, bg = '#202020'},
    ...
    MatchParen = {fg = 'yellow', bg = zephyr.none},
    ...
    Visual = {fg = zephyr.none, bg = zephyr.bg_visual, style = 'bold'},
    ...
    TSKeywordFunction = {fg = zephyr.aqua},
    TSProperty = {fg = 'darkseagreen'},
    ...
    BufferCurrent = {fg = 'aquamarine', bg = '#121212'},
    BufferCurrentSign = {fg = 'aquamarine', bg = '#121212'}
  }
  return syntax
end
